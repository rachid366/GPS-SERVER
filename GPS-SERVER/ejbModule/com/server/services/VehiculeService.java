...
public class VehiculeService extends UnicastRemoteObject implements IVehicule {
	...
	@PostConstruct
	public void init() {
		this.ajouter(new Vehicule("VD1222", "DACIA", "2*4",200));
		this.ajouter(new Vehicule("VD1272", "DACIA LOGAN", "DF4",200));
		this.ajouter(new Vehicule("VD125", "DUSTER", "TYPE C",100));
	}
